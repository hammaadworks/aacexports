...
const verticals = [{
    ...
    description: "Premium granite, marble, sandstone, iron & steel — sourced and supplied with strict quality control.",
    icon: Package,
    href: "/verticals/general",
    details: ["Stones", "Iron", "Steel"],
}, {
    title: "Food Stuff Trading",
    category: "Agriculture",
    description: "Basmati & Non‑Basmati rice, spices, and fresh produce — graded, polished, and prepared for global distribution.",
    icon: Wheat,
    href: "/verticals/food",
    ...
    description: "Clean‑label, potent ingredients for industrial and culinary brands worldwide.",

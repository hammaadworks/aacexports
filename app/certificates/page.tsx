...
const certificates = [
  {
    ...
    description:
      "Ensures that food products undergo quality checks and curtail food adulteration.",
    icon: ShieldCheck,
    file: "fssai.pdf",
  },
  {
    ...
    description:
      "Official tax registration ensuring compliance with Indian tax laws.",
    icon: FileText,
    file: "gst.pdf",
  },
  {
    ...
    description:
      "Primary license for undertaking import/export activities in India.",
    icon: FileText,
    file: "iec.pdf",
  },
  {
...
export default function CertificatesPage() {
  ...
  return (
    <VerticalPageWrapper>
      <VerticalHero
        icon={ShieldCheck}
        badgeText="Certificate Library"
        title={
          <>
            Legal & <span className="text-chart-3 italic">Compliance.</span>
          </>
        }
        description={
          <>
            Transparency is the foundation of our business. View our official
            registrations and certifications below.
          </>
        }
      ></VerticalHero>
      ...
      >
        ...
        >
          {selectedCert && (
            <Document
              file={`/certificates/${selectedCert.file}`}

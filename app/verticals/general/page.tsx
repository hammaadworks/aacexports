        ...
        <div className="relative min-h-screen bg-[#FDFCF8] text-foreground overflow-hidden" ref={targetRef}>
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-10">
                            Since 1996, Al Ahmed Continental has been a pillar of reliability. We quarry, process, and export
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">IEC Compliance</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="stones" className="py-24 container mx-auto px-6">
                <div className="mb-16 text-center max-w-3xl mx-auto">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif font-bold mt-2 mb-6 text-[#2D3028]">Natural Stones & Granite</h2>
            ...
            <section className="py-24 bg-[#E8E6E1] relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                     <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mt-4 mb-6 text-[#2D3028]">Iron & Steel</h2>
                        <p className="text-lg text-muted-foreground">
                            The backbone of infrastructure. We source TMT bars and structural steel from India's most reputed manufacturers, ensuring high ductility and earthquake resistance.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mt-12">
                         <MagicCard className="p-8 bg-white/50 border-white/20">
                            ...
                            <p className="text-sm text-muted-foreground">All products meet Bureau of Indian Standards (BIS) IS 1786:2008.</p>
                         </MagicCard>
                         <MagicCard className="p-8 bg-white/50 border-white/20">
                            <Layers className="w-10 h-10 mb-4 text-[#2D3028]" />
                            <h3 className="font-bold text-lg mb-2">Diverse Forms</h3>
                            <p className="text-sm text-muted-foreground">Billets, Structural Steel, Angles, Channels, and Beams.</p>
                         </MagicCard>
                         <MagicCard className="p-8 bg-white/50 border-white/20">
                            <Globe className="w-10 h-10 mb-4 text-[#2D3028]" />
                            <h3 className="font-bold text-lg mb-2">Global Logistics</h3>
                            <p className="text-sm text-muted-foreground">Efficient handling of bulk cargo and container shipments.</p>
                         </MagicCard>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 container mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                         ...
                         <h2 className="text-4xl font-serif font-bold mt-4 mb-6 text-[#2D3028]">Electricals & Electronics</h2>
                        ...
                        <ul className="space-y-4">
                         ...
                         <Button className="mt-8 bg-[#2D3028] text-white rounded-full" onClick={openModal}>Request Catalog</Button>
                    </div>
                     <div className="relative h-80 rounded-2xl overflow-hidden bg-gradient-to-br from-blue-900 to-slate-900 flex items-center justify-center">

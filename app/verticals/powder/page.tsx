...
import {Atom, Factory, FlaskConical, Leaf, Zap} from "lucide-react";
            ...
            <section className="py-20 bg-white border-y">
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8 text-center divide-x divide-gray-100">
                        <div className="px-4">
                            <div
                                className="mx-auto h-12 w-12 bg-green-100 rounded-full flex items-center justify-center text-green-700 mb-4">
                                <Leaf size={24}/>
                            </div>
                            <h3 className="font-bold text-lg mb-2">100% Natural</h3>
                            <p className="text-sm text-muted-foreground">
                                Sourced from fresh produce and dehydrated at low temperatures to
                                retain color and nutrients.
                            </p>
                        </div>
                        <div className="px-4">
                            <div
                                className="mx-auto h-12 w-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-700 mb-4">
                                <Factory size={24}/>
                            </div>
                            <h3 className="font-bold text-lg mb-2">Industry Ready</h3>
                            <p className="text-sm text-muted-foreground">
                                Available in bulk packing (10kg/20kg) with consistent mesh size
                                and moisture control.
                            </p>
                        </div>
                        <div className="px-4">
                            <div
                                className="mx-auto h-12 w-12 bg-orange-100 rounded-full flex items-center justify-center text-orange-700 mb-4">
                                <Zap size={24}/>
                            </div>
                            <h3 className="font-bold text-lg mb-2">High Potency</h3>
                            <p className="text-sm text-muted-foreground">
                                Concentrated flavor profiles that mean you use less to achieve
                                the desired taste.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-24 container mx-auto px-6">
                <div className="mb-16 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-muted-foreground">
                        We specialize in producing powders that serve as essential
                        ingredients for the global food processing and spice industries.
                    </p>
                </div>
            ...
            <section className="py-24 bg-[#E8E6E1] relative overflow-hidden">
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-4xl font-serif font-bold mb-6 text-[#2D3028]">
                                Applications
                            </h2>
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            Consistent flavor bases for hotels, restaurants, and
                                            catering.
                                        </p>
                                    </div>
                                </li>
                        ...
                        <div className="relative">
                            <MagicCard
                                className="p-8 bg-white border-none shadow-xl flex flex-col items-center justify-center text-center">
                                <h3 className="text-2xl font-serif font-bold mb-8">
                                    Our Process
                                </h3>
                                <div className="flex flex-col gap-4 items-center w-full">
                                    <div
                                        className="w-full max-w-xs p-4 border rounded-xl bg-green-50 text-green-800 font-medium">
                                        Fresh Harvest
                                    </div>
                                    <div className="h-6 w-px bg-gray-300"></div>
                                    <div
                                        className="w-full max-w-xs p-4 border rounded-xl bg-blue-50 text-blue-800 font-medium">
                                        Washing & Sorting
                                    </div>
                                    <div className="h-6 w-px bg-gray-300"></div>
                                    <div
                                        className="w-full max-w-xs p-4 border rounded-xl bg-orange-50 text-orange-800 font-medium">
                                        Dehydration
                                    </div>
                                    <div className="h-6 w-px bg-gray-300"></div>
                                    <div
                                        className="w-full max-w-xs p-4 border rounded-xl bg-purple-50 text-purple-800 font-medium">
                                        Pulverization
                                    </div>
                                </div>
                            </MagicCard>

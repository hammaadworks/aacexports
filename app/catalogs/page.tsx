...
const catalogs = [
  {
    ...
    description:
      "Explore our exquisite collection of Granite, Marble, and Quartz. Perfect for timeless architectural projects.",
    icon: Gem,
  ...
  },
  {
    ...
    description:
      "Farm-fresh vegetables and fruits sourced directly from growers. Quality and freshness guaranteed.",
    icon: Leaf,
  ...
  },
  {
    ...
    category: "FMCG",
    description:
      "A curated selection of premium spices, high-quality processed food items, snacks, and culinary essentials.",
    icon: Utensils,
    file: "food.pdf",
  },
  {
    ...
    description:
      "Premium dehydrated vegetable and fruit powders, and industrial-grade food ingredients for bulk export.",
    icon: PackageOpen,
    file: "powders.pdf",
  },
  {
    ...
    description:
      "Structural steel, raw materials, and heavy metal products for construction and manufacturing.",
    icon: Anvil,
    file: "ironsteel.pdf",
  },
];
  ...
  return (
    <VerticalPageWrapper>
      <VerticalHero
        ...
        description={
          <>
            Discover our diverse range of export-quality products. Browse
            detailed specifications and brochures designed to help you make
      ...
      <CustomContact
        ...
        bodyText={
          "We specialize in sourcing bespoke requirements. Request a quotation tailored to your specific market needs."
        }
          ...
          selectedDoc && (
            <div className="w-full flex justify-end px-6 py-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-t">
              <Button asChild variant="default">
                <a
                  href={`/catalogs/${selectedDoc.file}`}
                  target="_blank"
      ...
      >
        ...
        >
          {selectedDoc && (
            <Document
              file={`/catalogs/${selectedDoc.file}`}

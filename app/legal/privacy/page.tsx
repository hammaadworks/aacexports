          ...
          <BlurFade delay={0.1} inView>
            <div className="text-center mb-16">
                <div className="flex justify-center mb-6">
                     <PageHeaderBadge icon={ShieldCheck}>
                    Data Protection
                    </PageHeaderBadge>
                </div>
                ...
                We value your trust. This policy outlines our commitment to privacy and our "No Cookie" approach.
                </p>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={0.2} inView>
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 md:p-12 shadow-sm">
                ...
                <div className="mt-12 pt-8 border-t border-border flex items-center justify-center text-sm text-muted-foreground gap-2">
                    ...
                    <span>Securely processed. No tracking.</span>
                </div>
            </div>
          </BlurFade>
        </div>
